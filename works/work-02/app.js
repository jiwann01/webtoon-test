const episodes = [
  { number: 1, title: '1화', imagePaths: ['../../assets/exitless-cover.jpg'], imageHeights: [4961] },
  { number: 2, title: '2화', imagePaths: ['../../assets/exitless-cover.jpg'], imageHeights: [4961] },
  { number: 3, title: '3화', imagePaths: ['../../assets/exitless-cover.jpg'], imageHeights: [4961] },
];
...
async function prepareCover() {
  ...
  await preloadImage('../../assets/exitless-cover.jpg');
